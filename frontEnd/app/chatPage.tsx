...
const ChatPage: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col bg-gray-900">
      <Card className="flex flex-col flex-1 p-4 text-white bg-transparent">
                              ...
                              <div className="p-4 rounded mt-2 bg-gray-900">
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                  <div>
                                    ...
                                    <p>{message.data.scheduleTask.taskType}</p>
                                  </div>
                                  {message.data.scheduleTask.time && (
                                    <div>
                                      ...
                                      <p>
                                        {new Date(
                                          message.data.scheduleTask.time * 1000
                                        ).toLocaleString()}
                                      </p>
                                    </div>
                                  )}
